...
def rasters_of_bbox(bbox: tuple[float,float,float,float],
                    data_rasters,
                    square_label,
                    id_label):
    """
    ...
    id_min = raster_id_from_coordinates((west, south),
                                        data,
                                        square_label,
                                        id_label)
    id_max = raster_id_from_coordinates((east, north),
                                        data,
                                        square_label,
                                        id_label)
    if id_min == id_max:
