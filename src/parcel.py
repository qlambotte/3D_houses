...
def get_object_details(parcel):
    ...
    for obj in objects:
        if obj['objectType'] == 'gebouweenheid':
            ...
            details[f"building_{intermediate['identificator']['objectId']}"] = Polygon(geometry['polygon']['coordinates'][0])
...
def get_map_parcel(parcel_details, frac=0.3):
